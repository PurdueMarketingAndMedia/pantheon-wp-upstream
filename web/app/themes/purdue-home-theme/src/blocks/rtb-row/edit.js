...
const edit = (props) => {
  ...
  const { background, layout, rtbs, columns, paddingTop, paddingBottom, id, blockId, type, loop } = props.attributes;
    ...
    <InspectorControls key="1">
      <PanelBody>
        ...
        {type === "grid" ? (
          <PanelRow>
            <SelectControl
              label="Choose the number of columns to display on desktop."
