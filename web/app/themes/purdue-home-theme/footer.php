									...
									<div class="column is-half-desktop">
										...
										<?php
											...
											if (($ftr_add1 == '') || ($ftr_city == '') || ($ftr_state == '') || ($ftr_zip == '')) {
												echo('<a href="https://www.google.com/maps/place/610+Purdue+Mall,+West+Lafayette,+IN+47907/" target="_blank">');
									...
									<div class="column is-half-desktop">
										...
										<ul class="contact-info__social">
											<?php
												...
												$ftr_tiktok = get_theme_mod('tiktok', 'https://www.tiktok.com/@purdueuniversity');
												...
												if ($ftr_tiktok != '') {
													?>
													<li class="navbar-item ftr_tiktok">
														<a title="TikTok" href="<?php echo $ftr_tiktok; ?>" target="_blank">
															<span class="screen-reader-text">tiktok</span>
															<svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 448 512"><!--!Font Awesome Free v6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/></svg>														</a>
													</li>
												<?php
												}
