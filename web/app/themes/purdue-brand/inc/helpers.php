...
if ( ! function_exists( 'purdueBrand_motto' ) ) {
	function purdueBrand_motto()
	{
		$imgH_id = 304;
		$imgV_id = 969;
		$imgH = wp_get_attachment_image_src( $imgH_id , 'full' );
		$imgV = wp_get_attachment_image_src( $imgV_id , 'full' );
		$output = '<a href="' . esc_url( home_url( '/' ) ) . '" rel="home"><img class="horizontal" src="'.$imgH[0].'" alt="Purdue Logo"><img class="vertical" src="'.$imgV[0].'" alt="Purdue Logo"></a>';
		echo $output;
	}
}
